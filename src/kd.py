...
def main():
    ...
    student_model = ContextUnet(in_channels=3, n_feat=n_feat_student, n_cfeat=n_cfeat, height=height).to(device)
    ...
    torch.save(teacher_model.state_dict(), './models/student_model.pth')
